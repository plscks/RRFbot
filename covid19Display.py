...
def databaseGrab():
    ...
    worldData.append(worldRows[0][1])
    worldData.append(worldRows[0][2])
    ...
    c.execute(usQuery)
    usRows = c.fetchall()
    usData.append(usRows[0][2])
    usData.append(usRows[0][3])
    ...
    localData.append(localRows[0][2])
    localData.append(localRows[0][3])
